...
$installation = [
  'id'          => 'FRXXE7400123',
  'nom_station' => 'Station Brest â€” Rue de l\'Alma',
  'amenageur'   => 'R3',
  'siren'       => '902 726 488',
  'operateur'   => 'SPV COM',
...
<div class="content">
  ...
  <div class="detail-card">
    ...
    <div class="detail-card-header">
      ...
      <a href="/php/edit.php?id=<?= urlencode($id) ?>"><button class="btn-edit">âœŽ Modifier</button></a>
    </div>
    ...
    <div class="detail-card-body">
      ...
      <div class="detail-group">
        <div class="detail-group-title">AmÃ©nageur &amp; OpÃ©rateur</div>
        <div class="detail-grid-2">
          <div class="detail-field"><span class="detail-key">AmÃ©nageur</span><span class="detail-val"><?= htmlspecialchars($installation['amenageur']) ?></span></div>
          ...
          <div class="detail-field"><span class="detail-key">OpÃ©rateur</span><span class="detail-val"><?= htmlspecialchars($installation['operateur']) ?></span></div>
      ...
      <div class="detail-group">
        <div class="detail-group-title">CaractÃ©ristiques techniques</div>
        <div class="detail-grid-2">
